...
#End Region
    ...
    Private Sub Frm_schedule_encoding_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        If e.CloseReason = CloseReason.UserClosing Then
            If RadMessageBox.Show("If you proceed this command all queued data will be remove and all unprocess data will erase.?", "Warning!", MessageBoxButtons.YesNo, RadMessageIcon.Question) = Windows.Forms.DialogResult.Yes Then
                'Frm_main.Enabled = True
            Else
                e.Cancel = True
            End If
    ...
    Private Sub btn_schedule_detaildone_Click(sender As Object, e As EventArgs) Handles btn_schedule_detaildone.Click
        ...
        If msg = vbYes Then
            If count_remain = 0 Then
                RadMessageBox.Show("No more data item to be updated.")
