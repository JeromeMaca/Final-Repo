...
Public Class Frm_databaseConnection
    ...
    Private Sub cb_serverdatabasename_Click(sender As Object, e As EventArgs) Handles cb_serverdatabasename.Click
        ...
        Catch ex As Exception
            RadMessageBox.Show("Please Contact your System Administrator." & vbCrLf & ex.Message.ToString, "ERROR!", MessageBoxButtons.OK, RadMessageIcon.Error)
            Exit Sub
        End Try
    End Sub
    ...
    Private Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        ...
        If Me.txt_servername.Text <> "" And Me.cb_serverdatabasename.Text <> "" Then
            ...
            My.Settings.Save()
            RadMessageBox.Show("Successfully Configured...", "Done!", MessageBoxButtons.OK, RadMessageIcon.Info)
            Me.Close()
        Else
            RadMessageBox.Show("Incomplete Data Set-up!", "System Warning!", MessageBoxButtons.OK, RadMessageIcon.Exclamation)
        End If
    ...
    Private Sub btn_reset_Click(sender As Object, e As EventArgs) Handles btn_reset.Click
        ...
        RadMessageBox.Show("Successfully Reset Configuration...", "Done!", MessageBoxButtons.OK, RadMessageIcon.Info)
        'Me.Close()
    End Sub
    ...
    Private Sub Frm_databaseConnection_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Else
            RadMessageBox.Show("No Current Configuration Setting.", "System Warning!", MessageBoxButtons.OK, RadMessageIcon.Exclamation)
        End If
